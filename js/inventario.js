var inventario = {
    ...
    mostrar: function(x, y, registroTemporal){
        ...
        document.getElementById(idCabecera).style.backgroundColor = "#153450";
        document.getElementById(idCabecera).style.padding = "0.3em";

        document.getElementById(idContenido).style.backgroundColor = "#294052";
        ...
        document.getElementById(id).style.backgroundColor = "#294052";
